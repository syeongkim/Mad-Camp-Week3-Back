...
//   async createUserPost(username: string): Promise<UserPost> {
//     const newUserPost = new this.userPostModel({ username, posts: [] });
//     return newUserPost.save();
//   }
  
//   async getSentPosts(username: string): Promise<UserPost> {
